$(document).ready(function () {
  ...
  function loadStudentInfo() {
    $.ajax({
      type: "GET",
      url: "abilityAnalysis/studentInfo",
      data: {
  ...
  function loadTechnologyAnalysisData() {
    $.ajax({
      type: "GET",
      url: "abilityAnalysis/learningTechnology",
      data: {
        studentUniversityCode: model.universityCode,
        studentSchoolID: model.schoolID,
        studentID: model.studentID,
  ...
  function loadKnowledgeAnalysis(technologyID) {
    $.ajax({
      type: "GET",
      url: "abilityAnalysis/knowledgeAnalysis",
      data: {
        studentUniversityCode: model.universityCode,
        studentSchoolID: model.schoolID,
        studentID: model.studentID,
  ...
  function loadExerciseAnalysis(technologyID) {
    $.ajax({
      type: "GET",
      url: "abilityAnalysis/exerciseAnalysis",
      data: {
        studentUniversityCode: model.universityCode,
        studentSchoolID: model.schoolID,
        studentID: model.studentID,
  ...
  function loadExercisePercentAnalysis (technologyID) {
    $.ajax({
      type: "GET",
      url: "abilityAnalysis/exercisePercentAnalysis",
      data: {
        studentUniversityCode: model.universityCode,
        studentSchoolID: model.schoolID,
        studentID: model.studentID,
