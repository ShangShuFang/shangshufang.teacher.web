...
pageApp.controller('pageCtrl', function ($scope, $http) {
  ...
  $scope.onFilterByTechnology = function (technology) {
    $scope.model.selectedTechnology = technology === undefined ?
        {technologyID: 0, technologyName: '全部'} :
        {technologyID: technology.technologyID, technologyName: technology.technologyName};
    $scope.loadStudentAbilityList();
  };
