...
exports.buildRenderData = function(title, pageNumber, pageSize, serviceResult) {
    ...
    if (serviceResult.err || !serviceResult.content.result) {
        ...
        let paginationArray = pagingUtils.getPaginationArray(pageNumber, pageSize, serviceResult.content.totalCount);
        let prePaginationNum = pagingUtils.getPrePaginationNum(pageNumber);
        let nextPaginationNum = pagingUtils.getNextPaginationNum(pageNumber, pageSize, serviceResult.content.totalCount);
